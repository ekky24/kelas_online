...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="index.html"><i class="fas fa-users"></i> <span>Manage Member</span></a> </li>
    <li> <a href="charts.html"><i class="fas fa-book"></i>Manage Class</span></a> </li>
